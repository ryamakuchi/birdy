...
export const InputNumber: React.FC<InputNumberProps> = ({
  ...
  const mode = error
    ? classNames('border-red-500 focus-within:ring-red-500 focus-within:text-red-600', value !== null && 'text-red-600')
    : classNames(
  ...
  const sizeModePadding =
    size === 'small'
      ? classNames('px-2 py-3 focus-within:pt-5 focus-within:pb-1', value !== null && 'pt-5 pb-1')
      : size === 'medium'
      ? classNames('px-3 py-4 focus-within:pt-6 focus-within:pb-2', value !== null && 'pt-6 pb-2')
      : size === 'large'
      ? classNames('px-4 py-5 focus-within:pt-7 focus-within:pb-3', value !== null && 'pt-7 pb-3')
      : ''
